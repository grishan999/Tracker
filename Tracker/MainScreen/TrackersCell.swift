...
final class TrackersCell: UICollectionViewCell {
    ...
    private lazy var plusButton: UIButton = {
        ...
        let button = UIButton.systemButton(with: plusImage, target: self, action: #selector(plusButtonTapped))
    ...
    override init(frame: CGRect) {
        ...
        // Активируем autolayout для всех элементов
        [trackerNameView, emojiLabel, emojiCircle, trackerNameLabel,
         countView, countLabel, plusButton].forEach {
        ...
        NSLayoutConstraint.activate([
            ...
            trackerNameView.heightAnchor.constraint(equalToConstant: 90), // Явно задаем высоту
            
            // Круг для эмодзи
            emojiCircle.topAnchor.constraint(equalTo: trackerNameView.topAnchor, constant: 12),
            emojiCircle.leadingAnchor.constraint(equalTo: trackerNameView.leadingAnchor, constant: 12),
            ...
            // Название трекера (исправленные констрейнты)
            trackerNameLabel.topAnchor.constraint(greaterThanOrEqualTo: emojiCircle.bottomAnchor, constant: 8),
            trackerNameLabel.leadingAnchor.constraint(equalTo: trackerNameView.leadingAnchor, constant: 12),
            trackerNameLabel.trailingAnchor.constraint(equalTo: trackerNameView.trailingAnchor, constant: -12),
            trackerNameLabel.bottomAnchor.constraint(equalTo: trackerNameView.bottomAnchor, constant: -12),
            
            // Нижняя панель с количеством
            countView.topAnchor.constraint(equalTo: trackerNameView.bottomAnchor),
            ...
            plusButton.trailingAnchor.constraint(equalTo: countView.trailingAnchor, constant: -12),
